      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className="grid grid-cols-1 sm:grid-cols-12 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16">
          <div className="lg:col-span-4 md:col-span-6 col-span-6">
            <span className="font-extrabold text-3xl tracking-tight text-primary bg-clip-text">MindCrypto</span>
            ...
            <h3 className="text-white text-24 font-medium sm:mt-20 mt-12">
              2025 Copyright | MindCrypto
            </h3>
            <h3 className="text-white text-24 font-medium sm:mt-20 mt-12">
              Distributed by <a href="https://themewagon.com" target="_blank">Mindscape Analytics</a>
            </h3>
          </div>
            ...
            <ul>
              {headerData.map((item, index) => (
                <li key={index} className="pb-4">
                  <Link
                    href={item.href}
                    className="footer-link text-white hover:text-primary text-17 font-semibold underline-offset-4"
                  >
                    {item.label}
                  </Link>
                </li>
